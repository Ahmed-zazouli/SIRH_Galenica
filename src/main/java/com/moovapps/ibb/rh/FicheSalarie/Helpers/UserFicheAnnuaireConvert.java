package com.moovapps.ibb.rh.FicheSalarie.Helpers;
...
public class UserFicheAnnuaireConvert {
	...
	public static IUser fromFicheToUser(IStorageResource userFiche){
	...
	if(userFiche.getValue("MotDePasse")!=null) {
		...
		user.getExtendedAttributes().setValue("ContractType", userFiche.getValue("ContractType"));
