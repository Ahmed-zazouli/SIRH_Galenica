...
public class MaFicheSalarie extends BaseViewExtension {
...
//	}
	...
	private void setReferenceClickable(ViewItem iViewItem) {
		...
		{
			ViewModelItem viewModelItem = iViewItem.getViewModelItem();
            String link = "/moovapps/easysite/workplace/salarie/edit-document/" + iViewItem.getResource().getId().toInt() + "?flag=true";
