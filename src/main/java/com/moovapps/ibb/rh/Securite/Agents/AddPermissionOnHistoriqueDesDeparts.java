...
public class AddPermissionOnHistoriqueDesDeparts extends BaseAgent {
        ...
        try{
            ...
            if(competencesCollaborateur!=null && !competencesCollaborateur.isEmpty()){
                for(IStorageResource competenceCollaborateur : competencesCollaborateur){
                    ...
                    IUser collaborateur = (IUser) competenceCollaborateur.getValue("Collaborateur");
    ...
    ArrayList<IStorageResource> getCompetencesCollaborateur(){
        ...
        try{
            ...
            IResourceDefinition definition = getWorkflowModule().getResourceDefinition(sysContext,catalog,"HistoriqueDesDepartDesCollaborateurs");
