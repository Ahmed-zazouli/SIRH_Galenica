...
public class AddPermissionOnHistoriqueMissionCollaborateur extends BaseAgent {
    ...
    ArrayList<IStorageResource> getCompetencesCollaborateur(){
        ...
        try{
            ...
            IResourceDefinition definition = getWorkflowModule().getResourceDefinition(sysContext,catalog,"HistoriqueMissionsCollaborateurs");
