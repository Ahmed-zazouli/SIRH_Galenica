...
public class AddPermissionOnCongesExeptionnelle extends BaseAgent {
    ...
    ArrayList<IStorageResource> getCompetencesCollaborateur(){
        ...
        try{
            ...
            ICatalog catalog = getWorkflowModule().getCatalog(sysContext, "Referentiels", 4,project);
            IResourceDefinition definition = getWorkflowModule().getResourceDefinition(sysContext,catalog,"TypesCongesExceptionnelles");
