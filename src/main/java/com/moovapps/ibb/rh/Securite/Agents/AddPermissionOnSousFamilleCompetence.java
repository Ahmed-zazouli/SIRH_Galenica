...
public class AddPermissionOnSousFamilleCompetence extends BaseAgent {
    ...
    ArrayList<IStorageResource> getCompetencesCollaborateur(){
        ...
        try{
            ...
            IResourceDefinition definition = getWorkflowModule().getResourceDefinition(sysContext,catalog,"SousFamilleCompetence");
