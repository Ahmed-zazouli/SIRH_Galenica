...
public class AddPermissionOnActivite extends BaseAgent {

    @Override
    protected void execute() {
       try{
           ArrayList<IStorageResource> activites = getActivites();
           if(activites!=null && !activites.isEmpty()){
               for(IStorageResource activite : activites){
                   ISecurityController securityController = getWorkflowModule().getSecurityController(activite);
                   ...
                   IStorageResource societe = (IStorageResource) activite.getValue("Societe");
    ...
    ArrayList<IStorageResource> getActivites(){
        ...
        try{
            ...
            IResourceDefinition definition = getWorkflowModule().getResourceDefinition(sysContext,catalog,"Activite");
