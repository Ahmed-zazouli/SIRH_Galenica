...
public class AddPermissionOnMissionFonction extends BaseAgent {
        ...
        try{
            ...
            if(competencesCollaborateur!=null && !competencesCollaborateur.isEmpty()){
                for(IStorageResource competenceCollaborateur : competencesCollaborateur){
                    ...
                    IStorageResource societe = (IStorageResource) competenceCollaborateur.getValue("Societe");
    ...
    ArrayList<IStorageResource> getCompetencesCollaborateur(){
        ...
        try{
            ...
            IResourceDefinition definition = getWorkflowModule().getResourceDefinition(sysContext,catalog,"MissionFonctionPoste");
