...
public class AddPermissionOnFamilleCompetence extends BaseAgent {
    ...
    ArrayList<IStorageResource> getCompetencesCollaborateur(){
        ...
        try{
            ...
            IResourceDefinition definition = getWorkflowModule().getResourceDefinition(sysContext,catalog,"FamilleCompetence");
