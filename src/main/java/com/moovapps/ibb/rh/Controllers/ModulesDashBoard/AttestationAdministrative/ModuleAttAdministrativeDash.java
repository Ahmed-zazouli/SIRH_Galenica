...
public class ModuleAttAdministrativeDash extends BaseController {
	
	protected static final Logger log = Logger.getLogger(ModuleAttAdministrativeDash.class);
	...
	private JSONObject BuildData() {
		...
		try
		{
			...
			Collection<IWorkflowInstance> attestations =  getData();
			SimpleDateFormat monthYearFormat = new SimpleDateFormat("MM-yy");
				for (IWorkflowInstance attestation : attestations)
				{
					...
					tmp.put("Date demande", monthYearFormat.format((Date)attestation.getValue("sys_CreationDate")));
