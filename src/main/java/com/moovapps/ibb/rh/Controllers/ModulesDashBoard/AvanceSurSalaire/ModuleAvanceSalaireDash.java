...
public class ModuleAvanceSalaireDash extends BaseController {
	
	protected static final Logger log = Logger.getLogger(ModuleAvanceSalaireDash.class);
		...
		try
		{
			...
			SimpleDateFormat monthYearFormat = new SimpleDateFormat("MM-yy");
				for (IWorkflowInstance attestation : attestations)
				{
					...
					tmp.put("Montant", attestation.getValue("Montant") != null ? attestation.getValue("Montant") : "N/D");
