...
public class ModuleDossierMaladieDash extends BaseController {
	
	protected static final Logger log = Logger.getLogger(ModuleDossierMaladieDash.class);
		...
		try
		{
			...
			Collection<IWorkflowInstance> dossiersMaladie =  getData();
				for (IWorkflowInstance dossier : dossiersMaladie)
				{
					...
					tmp.put("Tier payeur", dossier.getValue("TierPayeur") != null ? dossier.getValue("TierPayeur") : "N/D");
					tmp.put("Statut", dossier.getText("DocumentState"));
