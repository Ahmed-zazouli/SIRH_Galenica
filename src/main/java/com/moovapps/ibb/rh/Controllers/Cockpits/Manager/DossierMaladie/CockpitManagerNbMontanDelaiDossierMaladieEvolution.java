...
public class CockpitManagerNbMontanDelaiDossierMaladieEvolution extends BaseController {
	...
	protected static final Logger log = Logger.getLogger(CockpitManagerNbMontanDelaiDossierMaladieEvolution.class);
...
//				mapObject.put("Montant remboursé", (Float)mapObject.get("Montant remboursé") + (Float)dossierMaladie.getValue("MontantRembourse"));
...
//						dateHelper.formatDateAsDate((Date)dossierMaladie.getValue("sys_CreationDate"), "dd-MM-yyyy") ,
//						dateHelper.formatDateAsDate(dateRemboursementPrevu, "dd-MM-yyyy")
//						)/(24*60);
//				mapObject.put("Délai instruction", (int)mapObject.get("Délai instruction") + delaiInstruction);
