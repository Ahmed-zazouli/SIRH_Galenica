...
public class CockpitManagerNbTrancheMontantAvanceSalaireParStatut extends BaseController {
	
	protected static final Logger log = Logger.getLogger(CockpitManagerNbTrancheMontantAvanceSalaireParStatut.class);
