...
public class CockpitManagerKpiAvanceSalaire extends BaseController {
	
	protected static final Logger log = Logger.getLogger(CockpitManagerKpiAvanceSalaire.class);
	...
	private JSONObject BuildData() {
		...
		try
		{
			...
			tmp.put("kpi1_value", (totalUsersSalary != 0) ? String.format("%.0f", ((totalAvanceDemande / totalUsersSalary)*100)) + "%":"N/A");
