...
public class CockpitRHNbTrancheMontantAvanceSalaire extends BaseController {

    protected static final Logger log = Logger.getLogger(CockpitRHNbTrancheMontantAvanceSalaire.class);
