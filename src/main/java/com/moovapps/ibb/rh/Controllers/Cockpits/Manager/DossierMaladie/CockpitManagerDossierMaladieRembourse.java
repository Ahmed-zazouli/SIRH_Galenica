...
public class CockpitManagerDossierMaladieRembourse extends BaseController {
	
	protected static final Logger log = Logger.getLogger(CockpitManagerDossierMaladieRembourse.class);
