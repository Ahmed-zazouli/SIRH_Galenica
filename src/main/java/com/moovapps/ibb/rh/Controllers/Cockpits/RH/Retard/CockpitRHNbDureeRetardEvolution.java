...
public class CockpitRHNbDureeRetardEvolution extends BaseController {
	...
	protected static final Logger log = Logger.getLogger(CockpitRHNbDureeRetardEvolution.class);
