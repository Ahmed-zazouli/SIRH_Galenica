...
public class CockpitManagerNbDureeSortie extends BaseController {
	
	protected static final Logger log = Logger.getLogger(CockpitManagerNbDureeSortie.class);
	...
	private JSONObject BuildData() {
		...
		try
		{
			...
			Collection<IWorkflowInstance> demandesSortie = getData();
			
				for (IWorkflowInstance sortie : demandesSortie)
				{
					String societeName = "N/D";
					IStorageResource societe = (IStorageResource) sortie.getValue("Societe");
					...
					String department = "N/D" ;
					String direction = "N/D";
					if (demandeur != null){
					 department = demandeur.getExtendedAttributes().getValue("Departement")!=null?(String) ((IStorageResource)demandeur.getExtendedAttributes().getValue("Departement")).getValue("sys_Title") : "";
					 direction = demandeur.getExtendedAttributes().getValue("Direction")!=null?(String) ((IStorageResource)demandeur.getExtendedAttributes().getValue("Direction")).getValue("sys_Title") : "";
					...
					tmp.put("Motif", sortie.getValue("motifSortie") != null ? sortie.getValue("motifSortie") : "N/D");
