...
public class CockpitManagerNbMontantAvanceSalaireEvolution extends BaseController {
	...
	private class GroupModel{
		...
		public GroupModel(String societe, IUser beneficiaire, String direction, String statut, String mois){
		...
		@Override
		public int hashCode() {
			return Objects.hash(societe, beneficiaire, direction, statut, mois);
		}
	}
	
	protected static final Logger log = Logger.getLogger(CockpitManagerNbMontantAvanceSalaireEvolution.class);
	...
	private JSONObject BuildData() {
		...
		{	
			...
			for (IWorkflowInstance avance : demandesAvance)
			{
				...
				beneficiaire = (IUser)avance.getValue("Beneficiaire");
