...
public class CockpitRhNbMontanDelaiDossierMaladieEvolution extends BaseController {
	...
	protected static final Logger log = Logger.getLogger(CockpitRhNbMontanDelaiDossierMaladieEvolution.class);
