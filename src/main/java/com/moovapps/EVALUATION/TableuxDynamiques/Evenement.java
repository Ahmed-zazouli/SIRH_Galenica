...
public class Evenement extends BaseDocumentExtension {
    ...
    public boolean onBeforeLoad() {
        ...
        String etatDEvaluation =getWorkflowInstance().getParentInstance().getValue("EtatDEvaluation")!=null? (String) getWorkflowInstance().getParentInstance().getValue("EtatDEvaluation"):"";
        ...
        if(collaborateur!=null && connectedUser.getId().toString().equals(collaborateur.getId().toString())){
            ...
            if(etatDEvaluation.equals("Auto-évaluation réalisée") || etatDEvaluation.equals("Entretien programmé") ){
                if (((IUser) getWorkflowInstance().getValue("sys_Creator")).getId().toString().equals(evaluateur.getId().toString()) ||
                        (((IUser) getWorkflowInstance().getValue("sys_Creator")).getLogin().equals("sysadmin") &&
                                getWorkflowModule().getLoggedOnUser().getId().toString().equals(
                                        ((IUser) getWorkflowInstance().getParentInstance().getValue("Evaluateur")).getId().toString()))) {
                    // N1 Modify
                    getWorkflowInstance().setValue("CollaborateurCanModify",false);
