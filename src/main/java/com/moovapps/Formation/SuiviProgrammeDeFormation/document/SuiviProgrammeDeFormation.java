...
public class SuiviProgrammeDeFormation extends BaseDocumentExtension {
    @Override
    public boolean onBeforeSubmit(IAction action) {

        if (action.getName().equals("FinirLeProgramme")) {
            Collection<IWorkflowInstance> poursParParticipant = getSuiviDeFormationByIDSession();
    ...
    public Collection<IWorkflowInstance> getSuiviDeFormationByIDSession() {
        ...
        try {
            ...
            IWorkflow w = Modules.getWorkflowModule().getWorkflow(sysContext, catalog, "SuiviDeFormation_1.1");
            ...
            controller.addNotEqualsConstraint("DocumentState", "Clôturé(e)");
    ...
    private void setCompetence() {
      if (getWorkflowInstance().getValue("QuizEtape") != null) {
          ...
          boolean SiProgramme = getWorkflowInstance().getValue("QuizEtape").equals("Programme") &&  (getWorkflowInstance().getValue("SouhaitezVousGererLesQuestionnaireAChaux") == null || getWorkflowInstance().getValue("SouhaitezVousGererLesQuestionnaireAChaux").equals("Non")) &&
                  (getWorkflowInstance().getValue("SouhaitezVousGererLesQuestionnaireAFroid") == null || getWorkflowInstance().getValue("SouhaitezVousGererLesQuestionnaireAFroid").equals("Non"));
          if (SiSans || SiProgramme) {
              ...
              for (ILinkedResource notationCompetence : notationCompetences) {
                  try {
                      ...
                      //getWorkflowModule().getWorkflowContainer(getWorkflowInstance().getWorkflow()).getName().equals("SuiviProgrammeDeFormation")
                      ...
                      } else if (!getWorkflowInstance().getValue("QuizEtape").equals("Sans")) {
