...
//
	...
	public HashMap<String, Object> calculateV2(IStorageResource societe,Date startDate, Date endDate, boolean ignoreJoursOuvrable) {
		...
		if (!joursOuvres.contains(keepingDateEndCalendar.get(Calendar.DAY_OF_WEEK))
		...
		int diffJoursOuvrablesJoursOuvres = joursOuvrables.size() - joursOuvres.size();

		boolean injoursOuvrablesNotjoursOuvres= false;

		if (!joursOuvres.contains(dateFinReelCalendar.get(Calendar.DAY_OF_WEEK)) && joursOuvrables.contains(dateFinReelCalendar.get(Calendar.DAY_OF_WEEK)) ) {
			injoursOuvrablesNotjoursOuvres = true;
		}
		...
		result.put("diffJoursOuvrablesJoursOuvres" , diffJoursOuvrablesJoursOuvres);
		result.put("injoursOuvrablesNotjoursOuvres",injoursOuvrablesNotjoursOuvres);
