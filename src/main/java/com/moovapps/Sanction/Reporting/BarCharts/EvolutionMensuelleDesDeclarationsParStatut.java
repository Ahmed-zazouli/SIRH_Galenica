...
public class EvolutionMensuelleDesDeclarationsParStatut extends BaseController {
    protected static final Logger log = Logger.getLogger(EvolutionMensuelleDesDeclarationsParStatut.class);
    ...
    ArrayList<IWorkflowInstance> getDeclarations(){
    ...
    private JSONObject BuildData() {
        ...
        ArrayList<IWorkflowInstance> declarations = getDeclarations();
        try {
