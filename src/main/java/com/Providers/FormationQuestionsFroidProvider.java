...
public class FormationQuestionsFroidProvider extends ResourceViewProvider {
    public FormationQuestionsFroidProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
    ...
    public void loadModel()
    {
        ...
        if ( viewDefinition != null && /*StringUtils.isNotEmpty( this.xmlViewElement.getAttribute( CONTEXT_PARAMETER_COLUMN ) ) &&*/ this.context.getParameterObject( IProvider.CURRENT_DOCUMENT ) != null )
        {
            ...
            try
            {
                ...
                fg.addFilter( new PropertyFilter( "IDFormationQuestionFroid", Operator.EQUALS, coreDocument.getResource().getValue("IDFormationQuestionFroid") != null ? coreDocument.getResource().getValue("IDFormationQuestionFroid") : "Empty" ) );
