...
public class SeanceProvider extends ResourceViewProvider {
    public SeanceProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
    ...
    public void loadModel()
    {
        ...
        if ( viewDefinition != null && /*StringUtils.isNotEmpty( this.xmlViewElement.getAttribute( CONTEXT_PARAMETER_COLUMN ) ) &&*/ this.context.getParameterObject( IProvider.CURRENT_DOCUMENT ) != null )
        {
            ...
            try
            {
                ...
                fg.addFilter( new PropertyFilter( "IDSeance", Operator.EQUALS, coreDocument.getResource().getValue("IDSeance") != null ? coreDocument.getResource().getValue("IDSeance") : "Empty" ) );
