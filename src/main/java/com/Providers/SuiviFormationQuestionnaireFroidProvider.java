...
public class SuiviFormationQuestionnaireFroidProvider extends ResourceViewProvider {
    public SuiviFormationQuestionnaireFroidProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
    ...
    public void loadModel()
    {
        ...
        if ( viewDefinition != null && /*StringUtils.isNotEmpty( this.xmlViewElement.getAttribute( CONTEXT_PARAMETER_COLUMN ) ) &&*/ this.context.getParameterObject( IProvider.CURRENT_DOCUMENT ) != null )
        {
            ...
            try
            {
                ...
                fg.addFilter( new PropertyFilter( "IDSessionQuestionFroid", Operator.EQUALS, coreDocument.getResource().getValue("IDSessionQuestionFroid") != null ? coreDocument.getResource().getValue("IDSessionQuestionFroid") : "Empty" ) );
