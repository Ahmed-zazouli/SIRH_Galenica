...
public class SessionQuestionsFroidProvider extends ResourceViewProvider {
    public SessionQuestionsFroidProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
