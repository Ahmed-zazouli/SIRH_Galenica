...
public class SuiviFormationProvider extends ResourceViewProvider {
    public SuiviFormationProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
    ...
    public void loadModel()
    {
        ...
        if ( viewDefinition != null && /*StringUtils.isNotEmpty( this.xmlViewElement.getAttribute( CONTEXT_PARAMETER_COLUMN ) ) &&*/ this.context.getParameterObject( IProvider.CURRENT_DOCUMENT ) != null )
        {
            ...
            try
            {
                ...
                fg.addFilter( new PropertyFilter( "IDSession", Operator.EQUALS, coreDocument.getResource().getValue("IDSession") != null ? coreDocument.getResource().getValue("IDSession") : "Empty" ) );
