...
public class FormationProvider extends ResourceViewProvider {
    public FormationProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
    ...
    public void loadModel()
    {
        ...
        if ( viewDefinition != null && /*StringUtils.isNotEmpty( this.xmlViewElement.getAttribute( CONTEXT_PARAMETER_COLUMN ) ) &&*/ this.context.getParameterObject( IProvider.CURRENT_DOCUMENT ) != null )
        {
            ...
            try
            {
                ...
                fg.addFilter( new PropertyFilter( "IDFormation", Operator.EQUALS, coreDocument.getResource().getValue("IDFormation")!= null ? coreDocument.getResource().getValue("IDFormation") : "Empty"  ) );
