...
public class ProgrammeQuestionsFroidProvider extends ResourceViewProvider {
    public ProgrammeQuestionsFroidProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
