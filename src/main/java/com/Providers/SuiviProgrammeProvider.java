...
public class SuiviProgrammeProvider extends ResourceViewProvider {
    public SuiviProgrammeProvider(INavigateContext context, CtlAbstractView view) {
        super(context, view);
    }
    ...
    public void loadModel()
    {
        ...
        if ( viewDefinition != null && /*StringUtils.isNotEmpty( this.xmlViewElement.getAttribute( CONTEXT_PARAMETER_COLUMN ) ) &&*/ this.context.getParameterObject( IProvider.CURRENT_DOCUMENT ) != null )
        {
            ...
            try
            {
                ...
                fg.addFilter( new PropertyFilter( "IDProgramme", Operator.EQUALS, coreDocument.getResource().getValue("IDProgramme") != null ? coreDocument.getResource().getValue("IDProgramme") : "Empty" ) );
